...
const xtime = moment.tz("Africa/Abuja").format("HH:mm:ss");
const xdate = moment.tz("Africa/Abuja").format("DD/MM/YYYY");
const time2 = moment().tz("Africa/Abuja").format("HH:mm:ss");
let pushwish = "";
...
> *${config.DESCRIPTION}*`;
    ...
    await Matrix.sendMessage(m.from, {
      audio: { url: 'https://files.catbox.moe/xku8r4.mp3' },
      mimetype: 'audio/mp4',
      ptt: true
    }, { quoted: m });
  }
