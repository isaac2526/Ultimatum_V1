    ...
    if (cmd === "update") {
        ...
        try {
            ...
            const { data: commitData } = await axios.get(
                "https://api.github.com/repos/isaac2526/Ultimatum_V1/commits/main"
            );
            ...
            const response = await axios({
                method: 'get',
                url: "https://github.com/isaac2526/Ultimatum_V1/archive/main.zip",
                responseType: 'stream'
            });
            ...
            const sourcePath = path.join(extractPath, "Ultimatum_V1-main");
